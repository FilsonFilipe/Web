...
<head>
  ...
  <link href="Estilo/lib/advanced-datatable/css/demo_page.css" rel="stylesheet" />
  <link href="Estilo/lib/advanced-datatable/css/demo_table.css" rel="stylesheet" />
  <link rel="stylesheet" href="Estilo/lib/advanced-datatable/css/DT_bootstrap.css" />
...
<body>
  ...
  <script type="text/javascript" language="javascript" src="Estilo/lib/advanced-datatable/js/jquery.js"></script>
  ...
  <script type="text/javascript" language="javascript" src="Estilo/lib/advanced-datatable/js/jquery.dataTables.js"></script>
  <script type="text/javascript" src="Estilo/lib/advanced-datatable/js/DT_bootstrap.js"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      nCloneTd.innerHTML = '<img src="Estilo/lib/advanced-datatable/images/details_open.png">';
      ...
      $('#hidden-table-info tbody td img').live('click', function() {
        ...
        if (oTable.fnIsOpen(nTr)) {
          ...
          this.src = "Estilo/lib/advanced-datatable/media/images/details_open.png";
          oTable.fnClose(nTr);
        } else {
          /* Open this row */
          this.src = "Estilo/lib/advanced-datatable/images/details_close.png";
