...
<head>
  ...
  <title>Login - Iniciar sessão</title>
...
<body>
      ...
      <form class="form-login" action="index.php">
        ...
        <div class="login-wrap">
          ...
          <label class="checkbox">
            ...
            <a data-toggle="modal" href="login.php#myModal"> Esqueceu a palavra-passe?</a>
            </span>
            </label>
          ...
          <div class="registration">
            Desenvolvido por: alertDANGER<br/>
            <a class="" href="#">
  ...
  <script type="text/javascript" src="Estilo/lib/jquery.backstretch.min.js"></script>
  <script>
    $.backstretch("Estilo/img/login-bg.jpg", {
      speed: 500
    });
  </script>
</body>
