...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Estilo/lib/gritter/css/jquery.gritter.css" />
...
<body>
      ...
      <section class="wrapper">
        <div class="row">
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="Estilo/img/ui-danro.jpg" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img src="Estilo/img/ui-zac.jpg" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <img src="Estilo/img/product.jpg" width="200" alt="">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img src="Estilo/img/friends/fr-06.jpg" class="img-circle" width="80">
                      <h4>DJ SHERMAN</h4>
                    </div>
                  </div>
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="Estilo/img/ui-divya.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="Estilo/img/ui-sherman.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="Estilo/img/ui-danro.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="Estilo/img/ui-zac.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
  ...
  <script src="Estilo/lib/jquery.sparkline.js"></script>
  <!--common script for all pages-->
  <script src="Estilo/lib/common-scripts.js"></script>
  <script type="text/javascript" src="Estilo/lib/gritter/js/jquery.gritter.js"></script>
  <script type="text/javascript" src="Estilo/lib/gritter-conf.js"></script>
  <!--script for this page-->
  <script src="Estilo/lib/sparkline-chart.js"></script>
  <script src="Estilo/lib/zabuto_calendar.js"></script>
